...
fun AuthField(
    ...
    Column(modifier = modifier.fillMaxWidth()) {
        Text(
            ...
            color = if (enabled) MaterialTheme.colorScheme.onSurfaceVariant else MaterialTheme.colorScheme.onSurfaceVariant.copy(alpha = disabledAlpha),
        ...
        OutlinedTextField(
            ...
            leadingIcon = {
                Icon(
                    ...
                    tint = when {
                        !enabled -> MaterialTheme.colorScheme.primary.copy(alpha = disabledAlpha)
            ...
            colors = OutlinedTextFieldDefaults.colors(
                ...
                disabledLeadingIconColor = MaterialTheme.colorScheme.primary.copy(alpha = disabledAlpha),
                disabledTrailingIconColor = MaterialTheme.colorScheme.primary.copy(alpha = disabledAlpha),
